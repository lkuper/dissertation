...
\begin{lem}[Independence]\label{lem:independence}
  ...
  \TODO{We're probably going to have to add another assumption to the
    statement of this lemma to make the {\sc E-Put} case go through,
    now that we're dealing with arbitrary update operations.  I still
