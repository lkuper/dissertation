...
\begin{lem}[Permutability, $\lambdaLVar$]\label{lem:lvars-permutability}
...
\begin{lem}[Internal Determinism, $\lambdaLVar$]\label{lem:lvars-internal-determinism}
...
\begin{lem}[Locality, $\lambdaLVar$]\label{lem:lvars-locality}
...
\begin{lem}[Monotonicity, $\lambdaLVar$]\label{lem:lvars-monotonicity}
...
\begin{lem}[Error Preservation, $\lambdaLVar$]\label{lem:lvars-error-preservation}
