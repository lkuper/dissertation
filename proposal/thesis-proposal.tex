...
I will illustrate the LVars programming model through three case
studies, all of which will make use of handlers and freezing:
\begin{itemize}
...
\item Third, I will describe our experience using LVish to parallelize
  PhyBin~\cite{PhyBin}. \lk{TODO: write about PhyBin}
\end{itemize}
...
In this section I discuss the key technical aspects of my approach.
Most of the omitted details can be found in already-published
