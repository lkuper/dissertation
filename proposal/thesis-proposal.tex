...
replicated objects in a distributed system.  In the next few sections,
I review the basics of CRDTs from the work of Shapiro
\etal~\cite{crdts, crdts-tr} and discuss the relationship between
CRDTs and LVars.
