...
\emph{commutative}.  CRDTs specified in the convergent style are also
called ``convergent replicated data types'', abbreviated ``CvRDTs''.
I begin with the state-based style here because it is closer to the
LVars model, although, as we will see, state-based specifications can
emulate operation-based ones, and vice versa.
...
\end{itemize}
But there is also another interesting possibility.  As I mentioned
above,
...
As discussed in Section~\ref{section:intro}, the LVars model builds on
