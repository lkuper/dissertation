...
\emph{convergent}; or \emph{operation-based}, also known as
\emph{commutative}.  CRDTs specified in the former style are also
...
specified using \emph{commutative operations}, as follows:
