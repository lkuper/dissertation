\documentclass[12pt,twoside,final]{iuthesis-alt}

% This is the dissertation, not the article
...
% Stuff for ensuring that figure captions are single-spaced and
% consistently spaced from the figure.  Not sure why this works, but
% it seems to.
\usepackage{subfig}
