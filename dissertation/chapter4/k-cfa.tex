...
In this section, \either{I}{we} describe a case study that fits this mold:
\emph{parallelized control-flow analysis}.  \either{I}{We} discuss the process of
...
version by Might~\shortcite{MightkCFABlog}.\footnote{Haskell port by Max
  Bolingbroke:
...
\etal~\shortcite{earl-might-icfp-2012}.  In general, it proved difficult to
