...
In this section \either{I}{we} illustrate the use of the LVish library from the
...
examples.\footnote{The examples in this section, among others, are
  ...
  % at the time of this writing.\TODO{Update this.  The lvar-examples examples
  % have now been tested against 7.8.3, but I should double-check.}
}
...
before @runPar@ can return.  Also,\either{as before,}{} we have @new@, @put@,
...
language extensions.  In the following section, \either{I}{we} explain these
changes.
...
LVish programs.  For brevity, \either{I}{we} will elide the @LANGUAGE@ pragmas in
...
item.\footnote{The ``Pure'' in \il{Data.LVar.PureMap} distinguishes it
  ...
  resources are added.  \either{I}{We} discuss the role of lock-free data
...
against the principle of monotonic growth.\footnote{On the other hand,
  ...
  non-monotonic operations.  \either{I discuss the relationship of LVars to
