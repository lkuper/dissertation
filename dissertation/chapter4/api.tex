...
There are two other important differences between \either{the monad-par
program}{a monad-par implementation} and the LVish program: the @Par@ type constructor has gained
