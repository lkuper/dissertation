...
\section{Proof of Lemma~\ref{lem:internal-determinism}}\label{section:internal-determinism-proof}
\input{chapter3/quasi-determinism-internal-determinism-proof}
