...
In this dissertation, I show that taking \emph{lattice-based} data
...
interface to LVars (which I will explain in detail in
...
model; I formally extend the model to support these update operations
in Chapter~\ref{ch:quasi}, and in Chapter~\ref{ch:lvish} I discuss how
...
\item First, I describe using LVish to parallelize a control flow
  ...
  parallelized.  I contrast the LVish implementation with the original
