...
%% $\lubp{v_1}{v_2}$ is the lub of $v_1$ and $v_2$ if it is an element
%% $u$ of $D_p$ such that $v_1 \leqp u$, $v_2 \leqp u$, and for any $v
%% \in D_p$ such that $v_1 \leqp v$ and $v_2 \leqp v$, it holds that
%% $u \leqp v$.
