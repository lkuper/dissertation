\begin{proof}
  ...
  \begin{itemize}
    ...
    \item Case $e = \putiexp{e_a}$: In this case, from the grammar of
      ...
      \putiexp{E_{11}}$ and $E_2 = [~]$. \TODO{this case}

    \item Case $e = \freeze{e_a}$: Similar to the case for $\putiexp{e_a}$.

    \item Case $e = \freezeafter{e_a}{e_b}{e_c}$: \TODO{this case}

    \item Case $e = \freezeafterfull{l}{Q}{\lam{x}{e_a}}{\setof{e_b, \dots}}{H}$: \TODO{this case}
