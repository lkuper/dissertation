\begin{proof}
  ...
  \begin{itemize}
    ...
    \item Case {\sc E-New}:
      ...
      \TODO{This case needs fixing.  We can't have both that $l \notin
        \dom{U_S(S)}$ and that $U_S$ is the identity on $l$.  The case
        can be made to work, work, but we need to nail down exactly
        what ``non-conflicting'' should mean for $U_S$.}
