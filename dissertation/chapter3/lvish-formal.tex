...
a least upper bound.  To make this possible we parameterize
$\lambdaLVish$ not only by the lattice $(D, \userleq, \bot, \top)$,
but also by a set $U$ of \emph{update operations}, as discussed
previously in
Section~\ref{subsection:lvars-generalizing-from-least-upper-bound-writes}:
