...
is $\error$.  As with the determinism proof for $\lambdaLVar$ that \either{I}{we}
...
operation in \either{Chapter}{Section}~\ref{ch:lvars} to the arbitrary update operations
