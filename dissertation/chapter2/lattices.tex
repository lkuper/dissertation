...
On the other hand, if we have an LVar whose states form the lattice of
...
\either{chapter}{section}: the requirement that updates be
...
\TODO{Update this section to use store update.}
...
\TODO{Update this section to be less lub-y.}
