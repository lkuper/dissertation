...
commute.  For example, the LVish Haskell library (which \either{I}{we} discuss in
...
of counters.\footnote{Unlike \il{put}, arbitrary update operations are
  ...
  writes in the LVish scheduler implementation.  \either{I}{We} discuss this
...
More precisely, \either{I}{we} replace the @put@ operation with a set of operations
...
logical ``and'' operation on two Boolean inputs.  \either{I'll}{We'll} call this data
