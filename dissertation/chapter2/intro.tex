...
programming model.  In this \either{chapter, I}{section, we} show how
...
interface to LVars (which \either{I}{we} will explain in detail
in \either{the sections that follow}{the rest of this section}): the
