...
expressions, $\PUTi$ expressions, or @new@.  The value forms include the
...
when an update operation would take an LVar's state to $\top$; in that
...
(minus $\PUTi$ and @get@) can support any \emph{series-parallel}
dependence graph.  Adding communication through $\PUTi$ and @get@
