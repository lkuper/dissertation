...
imperative disjoint parallel updates are compatible with LVars as
well.  Furthermore, as I show in Section~\ref{s:lvars-generalizing},
we can generalize the behavior of the @put@ and @get@ operations while
