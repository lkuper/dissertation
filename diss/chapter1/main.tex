...
\section{Quasi-deterministic programming with LVars}\label{s:intro-quasi}
...
\begin{itemize}
\item First, I describe how to add a primitive @freeze@ for
...
I discuss below in Section~\ref{s:intro-lvish}.

\lk{Editing mostly good up to here.}

\section{The relationship between LVars and distributed replicated data structures}\label{s:intro-cvrdts}

\lk{Swap this and the next section around to match order of chapters?}

\TODO{Edit this section to reflect what Chapter~\cite{ch:crdts} is
  actually about!}
...
\TODO{Say something about the previously published papers that this
  dissertation draws on.  Or, in individual chapters, say, ``The
  material in this chapter is based on research done jointly with...''
  and cite the papers.}
