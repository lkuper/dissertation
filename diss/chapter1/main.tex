...
as a common theme of guaranteed-deterministic programming
models.\footnote{We will later refine this definition of monotonic
  data structures to mean data structures to which information can
  only be added and never removed, \emph{and} for which the order in
  which information is added is not observable.\TODO{Add appropriate
