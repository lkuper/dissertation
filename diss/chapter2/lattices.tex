...
for common data structures.\TODO{Add forward reference to
  Figure~\ref{f:lvars-example-lattices}'s caption to where I talk
  about generalizing put to bump.}  The simplest example of a useful
...
its bindings, using the notation $\store{\storebindingRaw{l_1}{d_1},
  \dots, \storebindingRaw{l_n}{d_n}}$.  The state space of stores forms a
