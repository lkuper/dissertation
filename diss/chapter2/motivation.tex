...
unordered \emph{set} of vertex labels in a connected component.  Yet
before considering new mechanisms, we must also ask if a purely
functional program can do the job.
