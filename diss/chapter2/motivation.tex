...
a particular profile, one might wish to find all (or the first $k$
...
Before turning to an LVar-based approach, though, I will consider
...
that finished first.  Moreover, one would still have to contend with
...
how to implement a version of it using LVars that makes pipelining
possible and truly satisfies the above specification. \TODO{Put a
  forward reference to chapter 4 here instead?  Or maybe just do the
