...
of shared data structure, then, I take the more general notion of
monotonic data structures as a starting point for a new deterministic
parallel programming model.  This new model generalizes IVars
