...
\LVarsLemLocality
\begin{proof}
  \TODO{Add short description here.} See
...
at most one step, modulo a permutation on the locations in
$\conf_b$. \lk{We might not need that ``modulo a permutation'' bit,
  actually.}  Lemmas~\ref{lem:lvars-strong-one-sided-confluence}
