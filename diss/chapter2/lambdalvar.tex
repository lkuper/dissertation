...
\ref{f:lvars-lambdaLVar-semantics}, respectively.\TODO{Freshen up the
  Redex model of $\lambdaLVar$ and add it as an appendix.}  Both the
...
\TODO{Audit consistency of use of term notation: \lstinline|get|
  vs. \termfont{get} vs. $\GET$.}
