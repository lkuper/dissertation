\begin{proof}
  ...
  \TODO{I think this all needs to be rewritten.  I think what we're
    going to have to do is go case-by-case on pairs of eval contexts.
    $[~]$/$[~]$ is the base case and should follow from internal
    determinism of the reduction semantics, or something like that.}
