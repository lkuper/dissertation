\begin{proof}
  ...
  \item Case {\sc E-Beta}: We have $S_a = S$.
    ...
    \item \label{lvars-slc-beta-new}Case {\sc E-New}: We have $S_b =
      ...
      since the store did not change during the transition
    ...
    \item \label{lvars-slc-beta-put}Case {\sc E-Put}: We have $S_b =
      ...
      Furthermore, since the store did not change during the
    ...
    \item \label{lvars-slc-beta-put-err}Case {\sc E-Put-Err}:
      ...
      $\config{S_b}{\evalctxt{E'_a}{e_{a_1}}}$ is $\error$ as well.
      ...
      $\config{S_b}{\evalctxt{E'_b}{e_{b_2}}} = \error$, and so
  ...
  \item Case {\sc E-New}:
    ...
    $\config{S}{e_{b_1}}$ steps to $\config{S_b}{e_{b_2}}$:
    \begin{enumerate}
    \item Case {\sc E-Beta}: By symmetry with case~\ref{lvars-slc-beta-new}.
