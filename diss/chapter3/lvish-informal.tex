...
In general, the second argument to @addHandler@, which I call an
...
see that this kind of event set can be specified in a lattice-generic
way, and in Section~\ref{section:implementation} we will see that it
corresponds closely to our implementation strategy.
...
\subsection{A parallel graph traversal using handlers, quiescence, and freezing}
