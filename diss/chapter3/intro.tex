...
\TODO{The following three paragraphs were cribbed from the ``Safe,
  limited nondeterminism'' section that was cut from
  Chapter~\ref{ch:lvars}.  Figure out if they belong in this chapter,
  and, if so, where.}
