\section{The library implementation}\label{s:lvish-internals}

In this section, I describe the internals of the LVish
library. \TODO{More descriptive text here.}
...
\lk{I don't go to the subsubsection level (or the paragraph level)
  anywhere else.  Can I avoid doing it here?  Should I be doing it
  elsewhere?}
...
\subsubsection{Leveraging idempotence}
