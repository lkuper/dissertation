...
\lk{I removed the Clash lemma, because it's not clear that we need it.
  Should figure this out for sure, though.}
...
\lk{From here onward, most of the proofs need to be revised.}
